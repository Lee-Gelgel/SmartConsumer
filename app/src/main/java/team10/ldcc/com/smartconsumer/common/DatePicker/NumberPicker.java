...
public class NumberPicker extends View {
    ...
    private final String TAG = "NumberPicker";
...
//    private Sound mSound;
    ...
    private void readAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = a.getColor(R.styleable.NumberPicker_textColors, DEFAULT_TEXT_COLOR);
    ...
    private void initPaint() {
        ...
        mTextPaint2.setColor(Color.parseColor("#f77722"));
        mTextPaint2.setFlags(TextPaint.ANTI_ALIAS_FLAG);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null == mHighLightRect) {
            ...
            mHighLightRect.top = (mHeight+mTextBounds.height()) / 2;
            mHighLightRect.bottom = (mHeight-mTextBounds.height()) / 2;

            Shader topShader = new LinearGradient(0, mHighLightRect.top, 0, 0, new int[]{
            ...
            Shader bottomShader = new LinearGradient(0, mHeight, 0, mHighLightRect.bottom, new int[]{
                    mBackgroundColor & 0x00FFFFFF,
                    mBackgroundColor & 0x00FFFFFF,
                    mBackgroundColor & 0x00FFFFFF,
                    mBackgroundColor & 0x00FFFFFF,
